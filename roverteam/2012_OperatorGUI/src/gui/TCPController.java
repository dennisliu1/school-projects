 ...
 */
public class TCPController extends JPanel {
	TCPClient client;
	...
	public TCPController(TCPClient client) {
		...
		sendTextArea = new JTextArea(1, 10);
		...
		panels[1].add(connectionLabel);
		panels[1].add(receiveTextArea);
		panels[1].add(sendTextArea);
...
//		frameServer.setVisible(true);
		...
		TCPController gui = new TCPController(new TCPClient("localhost", 6000));
