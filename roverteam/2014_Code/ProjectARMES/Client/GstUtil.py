...
class GStreamerPipeline():
	...
	def addPipeline(self):
		...
		#gst-launch -v souphttpsrc location="http://192.168.11.3/videostream.cgi?user=admin&pwd=" do-timestamp=true is_live=true ! multipartdemux ! jpegdec ! ffmpegcolorspace ! autovideosink
		# strPipeline =  "souphttpsrc location=\"http://192.168.11.3/videostream.cgi?user=admin&pwd=\" do-timestamp=true is_live=true ! multipartdemux ! VideoSink name=\"videosink0\" sync=false"
		# strPipeline =  "souphttpsrc location=\"http://192.168.11.2/videostream.cgi?user=admin&pwd=\" do-timestamp=true is_live=true ! multipartdemux ! VideoSink name=\"videosink0\" sync=false"
